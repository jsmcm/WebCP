...
{
	$SendTo = $SendTo.substr($n, 4).",";
}

if(strlen($SendTo) == 0)
{
	header("Location: index.php?Notes=You%20have%20not%20selected%20groups%20to%20send%20to!");
	exit();
}
...
<html lang="en" class="no-js">
	...
	<head>
		...
		<script src="/includes/javascript/tinymce/tinymce.min.js"></script>
		<script>
		        tinymce.init(
			{
				selector:'textarea', plugins:'textcolor image hr link preview table', tools: 'insertable'}	
			);
		</script>
...
<b>Text Substitutions: </b> {first_name} &nbsp;&nbsp;{surname} &nbsp;&nbsp;{full_name}
<p>
<form name="SendMail" action="DoSend.php" method="post">
<input type="hidden" name="SendTo" value="<?php print $SendTo; ?>">
<b>Subject: </b><input name="Subject" type="text" placeholder="Subject" id="form-field-11" class="form-control"><P>&nbsp;<p>
<textarea name="TextToSend"></textarea>
<p>
<input type="submit" id="button" value="Send Now" data-style="zoom-in" class="btn btn-info ladda-button"  onclick="return ValidateMail(); return false;">
</form>
