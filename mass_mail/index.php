...
<html lang="en" class="no-js">
	...
	<head>
		...
		{
			if(Obj.name != "chk_0" && Obj.checked == true)
			{
				document.MailFilter.chk_0.checked = false;
			}	
			else if(Obj.name == "chk_0" && Obj.checked == true)
			{
				var elem = document.getElementById('MailFilter').elements;
		
				for(var i = 0; i < elem.length; i++)
			        {
			        	if( (elem[i].type == "checkbox") && (elem[i].name != "chk_0") )
					{				
...
print "<table cellpadding=\"5\" cellspacing=\"5\" width=\"100%\">";
print "<tr>";
print "<td width=\"200\">";
print "Send to All";
print "</td>";
print "<td width=\"*\">";
print "<input type=\"checkbox\" name=\"chk_0\" onclick=\"Selected(this);\">";
print "</td>";
print "</tr>";
...
print "<tr>";  
print "<td colspan=\"2\">";  
print "<hr style=\"border-style:solid; border-color:black; border-width:1px\">";  
print "</td>";  
print "</tr>";  
...
{  
        print "<tr>";  
        print "<td width=\"200\">";  
        print "Send to ".$PackageArray[$x]["package_name"];  
        print "</td>";  
        print "<td width=\"*\">";  
        print "<input type=\"checkbox\" name=\"chk_".$PackageArray[$x]["package_id"]."\" onclick=\"Selected(this);\">";  
        print "</td>";  
        print "</tr>";  
}  
...
print "<input value=\"Send Mail\" data-style=\"zoom-in\" class=\"btn btn-info ladda-button\" type=\"submit\">";
print "</form>";  
