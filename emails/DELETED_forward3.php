...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>Email Forwarding | WebCP</title>
		<!-- start: META -->
		<meta charset="utf-8" />
									...
									//print "Role: ".$oUser->Role."<p>";
										...
										for($x = 0; $x < $ArrayCount; $x++)
										{
											...
											print "<td>".$Array[$x]["ForwardTo"]."</td>\r\n";	
													...
													print "<a href=\"DeleteSingleForwarder.php?id=".$Array[$x]["ID"]."\" onclick=\"return ConfirmDelete(); return false;\" class=\"btn btn-bricky tooltips\" data-placement=\"top\" data-original-title=\"Delete Email\"><i class=\"fa fa-times fa fa-white\" style=\"color:white;\"></i></a>\n";
													print "</div>";
													print "<div class=\"visible-xs visible-sm hidden-md hidden-lg\">";
														print "<div class=\"btn-group\">";
															...
															print "<a role=\"menuitem\" tabindex=\"-1\" href=\"DeleteSingleForwarder.php?id=".$Array[$x]["ID"]."\" onclick=\"return ConfirmDelete(); return false;\">";
