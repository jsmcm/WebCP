...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>Domain Specific Email Limits | <?php print $oSettings->GetWebCPTitle(); ?></title>
		<!-- start: META -->
		<meta charset="utf-8" />
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<ol class="breadcrumb">
								...
								<li>
									<i class="active"></i>
									<a href="/emails/domains_limits.php">
										Domain Limits
									</a>
								</li>
							...
							<div class="page-header">
								<h1>Email Limits <small> Domain specific limits</small></h1>
							</div>
	...
	print "<td><a href=\"general_limits.php?DomainName=".$Array[$x]["domain_name"]."\">".$Array[$x]["domain_name"]."</a></td>\r\n";
												print "</tr>";
											}
										}
										?>
