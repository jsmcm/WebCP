...
if( ! $oSimpleNonce->VerifyNonce($Nonce, "editEmailAddress", $TimeStamp, $NonceMeta) )
{
        header("Location: index.php");
	exit();
}
...
$EmailAddress = $oEmail->GetEmailAddress($id);

if( $email_ClientID < 1)
{
	if( ($oEmail->GetEmailOwner($id) != $ClientID) && ($oUser->Role != "admin") )
	{
...
$NonceArrayMeta = array("id"=>$id, "emailAddress"=>$EmailAddress, "loggedInId"=>$loggedInId);
$EditNonceArray = $oSimpleNonce->GenerateNonce("doEditEmailAddress", $NonceArrayMeta);
...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>Edit Email Password | <?php print $oSettings->GetWebCPTitle(); ?></title>
		<!-- start: META -->
		<meta charset="utf-8" />
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<ol class="breadcrumb">
								...
								<li>
									<i class="active"></i>
									<a href="/emails/EditPassword.php">
										Edit Password
									</a>
								</li>
							...
							<div class="page-header">
								<h1>Edit Password <small><?php print $EmailAddress; ?></small> </h1>
							</div>
						...
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								...
								<form name="EditPassword" method="post" action="DoEditPassword.php" class="form-horizontal">
										...
										<input type="hidden" name="emailAddress" value="<?php print $EmailAddress; ?>">
										<input type="hidden" name="Nonce" value="<?php print $EditNonceArray["Nonce"]; ?>">
										<input type="hidden" name="TimeStamp" value="<?php print $EditNonceArray["TimeStamp"]; ?>">
