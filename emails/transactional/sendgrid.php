...
<?php
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<table class="table table-bordered table-full-width" id="sample_1">
										...
										{
											$transactionalEmail = $oEmail->getDomainTransactionalSetting($Array[$x]["id"]);

											print "<tr class=\"ActiveRow\">";
												
												print "<td><a href=\"http://".$Array[$x]["domain_name"]."\" target=\"_BLANK\">".$Array[$x]["domain_name"]."</a></td>\r\n";
												print "<td><a href=\"#\" id=\"domain_transactional_email_".$Array[$x]["id"]."\" data-type=\"select\" data-pk=\"".$Array[$x]["id"]."\" data-value=\"".$transactionalEmail."\" data-original-title=\"Transactional Email\"></a></td>\r\n";
		...
		<script src="/assets/js/index.js"></script>
                ...
                <script src="/assets/plugins/x-editable/transactional-email.js"></script>
