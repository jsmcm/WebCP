...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>Email Routing | <?php print $oSettings->GetWebCPTitle(); ?></title>
		<!-- start: META -->
		<meta charset="utf-8" />
		...
		function DoSubmit()
		{
			...
			if(document.AddRouting.DomainID.value == "-1")
			{
				alert("Please select a domain");
				document.AddRouting.DomainID.focus();
				return false;
			}
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>Routing <small>Manage email internal / external routing</small></h1>
							</div>
...
If you use an external mail provider, eg, gmail for business, please select "external" for your domain's routing.<p>If you are unsure what this setting does please do not change it or your mail will stop working.<p>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									//print "Role: ".$oUser->Role."<p>";
										...
										$oDomain->GetDomainList($RoutingArray, $RoutingArrayCount, $ClientID, $oUser->Role);

										for($x = 0; $x < $RoutingArrayCount; $x++)
										{
											print "<tr>";
											print "<td>".$RoutingArray[$x]["domain_name"]."</td>\r\n";	
											print "<td><a href=\"#\" id=\"routing_".$x."\" data-type=\"select\" data-pk=\"".$RoutingArray[$x]["id"]."\" data-value=\"".$RoutingArray[$x]["EmailRouting"]."\" data-original-title=\"Select routing\"></a></td>\r\n";	
