...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>Auto Reply | <?php print $oSettings->GetWebCPTitle(); ?></title>
		<!-- start: META -->
		<meta charset="utf-8" />
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>Auto Reply <small>Add / remove, auto responder</small></h1>
							</div>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									//print "Role: ".$oUser->Role."<p>";
										...
										$oEmail->GetAutoReplyList($Array, $ArrayCount, $loggedInId, $Role);
										...
										for($x = 0; $x < $ArrayCount; $x++)
										{
											...
											print "<td class=\"hidden-xs\">".$Array[$x]["Subject"]."</td>\r\n";	
													...
													print "<a href=\"AddAutoReply.php?ID=".$Array[$x]["ID"]."\" class=\"btn btn-green tooltips\" data-placement=\"top\" data-original-title=\"Edit Auto Reply\"><i class=\"fa fa-edit fa fa-white\" style=\"color:white;\"></i></a>\n";
														
													print "<a href=\"DeleteAutoReply.php?ID=".$Array[$x]["ID"]."\" onclick=\"return ConfirmDelete(); return false;\" class=\"btn btn-bricky tooltips\" data-placement=\"top\" data-original-title=\"Delete Auto Reply\"><i class=\"fa fa-times fa fa-white\" style=\"color:white;\"></i></a>\n";
													print "</div>";
													print "<div class=\"visible-xs visible-sm hidden-md hidden-lg\">";
														print "<div class=\"btn-group\">";
															...
															print "<a role=\"menuitem\" tabindex=\"-1\" href=\"AddAutoReply.php?ID=".$Array[$x]["ID"]."\">";
															print "<i class=\"fa fa-edit\"></i> Edit Auto Reply";
															print "</a>";
															print "</li>";
															
															print "<li role=\"presentation\">";
															print "<a role=\"menuitem\" tabindex=\"-1\" href=\"DeleteAutoReply.php?ID=".$Array[$x]["ID"]."\" onclick=\"return ConfirmDelete(); return false;\">";
															print "<i class=\"fa fa-times\"></i> Delete Auto Reply";
															print "</a>";
															print "</li>";																
															print "</ul>";
														print "</div>";
									...
									<a class="btn btn-primary" href="AddAutoReply.php"><i class="fa fa-plus"></i>
									Add new Auto Reply</a>
