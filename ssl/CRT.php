...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>Configure Certificate | <?php print $oSettings->GetWebCPTitle(); ?></title>
		<!-- start: META -->
		<meta charset="utf-8" />
		...
		function DoSubmit()
		{
			...
			if(document.ImportCRT.Certificate.value == "")
			{
				alert("You have not pasted a certificate file.");
				document.ImportCRT.Certificate.focus();
				return false;
			}
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>Configure SSL <small><?php print $Domain; ?> - Signing Request and Certificate Import</smalil> </h1>
							</div>
					...
					?>
						...
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								...
								<form name="ImportCRT" method="post" action="ImportCRT.php" class="form-horizontal">
									
										<input type="hidden" name="DomainName" value="<?php print $Domain; ?>">
										<input type="hidden" name="DomainID" value="<?php print $DomainID; ?>">
								
									
                                                                                <div class="form-group">
                                                                                        <label class="col-sm-2 control-label">
                                                                                               	CSR - Copy and paste this into your SSL vendors site
                                                                                        </label>
                                                                                        <div class="col-sm-4">
												...
												?>
                                                                                ...
                                                                                <div class="form-group">
                                                                                        <label class="col-sm-2 control-label">
                                                                                               	Import Certificate File. Paste the certificate file from vendor here
                                                                                        </label>
                                                                                        <div class="col-sm-4">
                                                                                                <span class="input-icon">
												<?php
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<input type="submit" value="Import Certificate" data-style="zoom-in" class="btn btn-info ladda-button" onclick="return DoSubmit(); return false;">
