								...
								<div class="panel-body">
									...
									<table class="table table-bordered table-full-width table-hover table-striped" id="sample_1">
										...
										for($x = 0; $x < $ArrayCount; $x++)
										{
											...
											if( ($Array[$x]["type"] == 'primary') && (in_array($Array[$x]["domain_name"], $KeyArray) == false) )
											{
											 	print "<tr>";
												print "<td>";
												print "<a href=\"CSR.php?DomainName=".$Array[$x]["domain_name"]."&DomainID=".$Array[$x]["id"]."\">".$Array[$x]["domain_name"]."</a>";
												print "</td>";
												print "</tr>";
											}
										}
