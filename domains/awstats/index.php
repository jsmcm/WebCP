...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>Awstats | <?php print $oSettings->GetWebCPTitle(); ?></title>
		<!-- start: META -->
		<meta charset="utf-8" />
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>Awstats <small>Select a domain to see its stats</small></h1>
							</div>
								...
								<div class="panel-body">
									...
									//print "Role: ".$oUser->Role."<p>";
										...
										for($x = 0; $x < $ArrayCount; $x++)
										{
											...
											{
											 	print "<tr>";
												print "<td><a href=\"/awstats/awstats.pl?config=".$Array[$x]["domain_name"]."&LoginToken=".session_id()."\" target=\"_blank\">".$Array[$x]["domain_name"]."</a></td>\r\n";
														print "</form>";
												print "</tr>";
											}
										}
