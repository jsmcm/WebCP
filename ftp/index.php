...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>FTP Management | <?php print $oSettings->GetWebCPTitle(); ?></title>
		<!-- start: META -->
		<meta charset="utf-8" />
		...
		{
			if(confirm("Are you sure you want to delete this FTP account?"))
			{
				return true;
			}
			return false;
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>FTP <small>Add / remove, change passwords</small></h1>
							</div>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									//print "Role: ".$oUser->Role."<p>";
										...
										$oFTP->GetFTPList($Array, $ArrayCount, $ClientID, $oUser->Role);

										for($x = 0; $x < $ArrayCount; $x++)
										{
											print "<tr>";
											print "<td>".$Array[$x]["User"]."</td>\r\n";	
											print "<td class=\"hidden-xs\">".$Array[$x]["fqdn"]."</td>\r\n";	
												

													print "<td class=\"center\">";
													print "<div class=\"visible-md visible-lg hidden-sm hidden-xs\">";
														
													print "<a href=\"EditPassword.php?id=".$Array[$x]["id"]."\" class=\"btn btn-green tooltips\" data-placement=\"top\" data-original-title=\"Edit Password\"><i class=\"fa fa-edit fa fa-white\" style=\"color:white;\"></i></a>\n";
														
													print "<a href=\"DeleteFTP.php?id=".$Array[$x]["id"]."\" onclick=\"return ConfirmDelete(); return false;\" class=\"btn btn-bricky tooltips\" data-placement=\"top\" data-original-title=\"Delete FTP\"><i class=\"fa fa-times fa fa-white\" style=\"color:white;\"></i></a>\n";
													print "</div>";
													print "<div class=\"visible-xs visible-sm hidden-md hidden-lg\">";
														print "<div class=\"btn-group\">";
															...
															print "<li role=\"presentation\">";
															print "<a role=\"menuitem\" tabindex=\"-1\" href=\"DeleteFTP.php?id=".$Array[$x]["id"]."\" onclick=\"return ConfirmDelete(); return false;\">";
															print "<i class=\"fa fa-times\"></i> Delete FTP";
															print "</a>";
															print "</li>";																
															print "</ul>";
														print "</div>";
									...
									<a class="btn btn-primary" href="AddFTP.php"><i class="fa fa-plus"></i>
									Add new FTP</a>
								</div>
							</div>
