...
if($Role != "admin")
{
	header("Location: /index.php?Notes=You do not have permission to do that!");
	exit();
}
...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>Restore an account | <?php print $oSettings->GetWebCPTitle(); ?></title>
		<!-- start: META -->
		<meta charset="utf-8" />
					...
					?>
						...
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								...
								<h1>Upload backup file</h1><p>	

								<form name="UploadForm" id="UploadForm" method="post" action="DoUploadFile.php" enctype="multipart/form-data" class="form-horizontal">
										...
										<div class="form-group">
											<div class="col-sm-4">
												...
												<input name="UploadedFile" type="file" id="form-field-11" class="form-control">
												</span>										
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<input type="submit" value="Upload File" data-style="zoom-in" class="btn btn-info ladda-button">
