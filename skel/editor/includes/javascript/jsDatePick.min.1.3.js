...
JsDatePick.prototype.makeCalendar=function()
{
	...
	JsDatePick.prototype.determineFieldDate=function()
	{
		...
		//if(this.lastPickedDateObject)
		if(JsgetElem(this.oConfiguration.target).value.length == 8)
		{
			...
			YearString= JsgetElem(this.oConfiguration.target).value;
			MonthString= JsgetElem(this.oConfiguration.target).value;
			DayString= JsgetElem(this.oConfiguration.target).value;

			YearString= YearString.substring(0, 4);
			MonthString= MonthString.substring(4,6);
			DayString= DayString.substring(6,8);

			
			this.setSelectedDay({year:parseInt(YearString, 10),month:parseInt(MonthString, 10),day:parseInt(DayString, 10)})
		}
		else
		{
	...
	{
		this.unsetSelection();if(typeof(this.oConfiguration.selectedDate)=="object"&&this.oConfiguration.selectedDate){this.setSelectedDay({year:parseInt(this.oConfiguration.selectedDate.year),month:parseInt(this.oConfiguration.selectedDate.month,10),day:parseInt(this.oConfiguration.selectedDate.day,10)})}}
	else
	{
