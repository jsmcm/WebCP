...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>Edit MySQL Root Password | <?php print $oSettings->GetWebCPTitle(); ?></title>
		<!-- start: META -->
		<meta charset="utf-8" />
		...
		function DoSubmit()
		{
			if(document.EditRootPassword.Password.value == "")
			{
				alert("Please enter a password");
				document.EditRootPassword.Password.focus();
				return false;
			}

			Password = document.EditRootPassword.Password.value;		
			
			if(Password.indexOf("\"") > -1)
			{
				alert("Password cannot contain a \" character...");
				document.EditRootPassword.Password.value = "";
				document.EditRootPassword.PasswordAgain.value = "";
				document.EditRootPassword.Password.focus();
				return false;
			}
			

			if(document.EditRootPassword.Password.value != document.EditRootPassword.PasswordAgain.value)
			{
			...
			if(CheckPassword(document.EditRootPassword.Password.value) < 3)
			{
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>MySQL Root Password <small> Change the root MySQL password</small> </h1>
							</div>
					...
					?>
						...
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								...
								<form name="EditRootPassword" method="post" action="DoEditRootPassword.php" class="form-horizontal">
											
				<input type="hidden" value="root" name="DBUser">				
				<input type="hidden" value="mysql" name="DBName">	
