...
$oMySQL->GetMySQLInfo($id, $MySQLUserName, $UserDatabaseName);
...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>Edit MySQL | <?php print $oSettings->GetWebCPTitle(); ?></title>
		<!-- start: META -->
		<meta charset="utf-8" />
		...
		function DoSubmitPassword()
		{
			...
			if(document.EditPassword.Password.value == "")
			{
				...
				return false;
                        ...
                        Password = document.EditPassword.Password.value;
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>Edit Database <small><?php print $MySQLUserName; ?></small> </h1>
							</div>
					...
					?>
							...
							<div class="panel panel-default">
								...
								<form name="EditPassword" method="post" action="DoEditPassword.php" class="form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="submit" value="Change Password" data-style="zoom-in" class="btn btn-info ladda-button" onclick="return DoSubmitPassword(); return false;">
						...
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								...
								<form name="EditHosts" method="post" action="DoEditHosts.php" class="form-horizontal">
									
										<input type="hidden" name="id" value="<?php print $id; ?>">
										<input type="hidden" name="UserName" value="<?php print $MySQLUserName; ?>">
								
										<div class="form-group" style="padding-left:20px;">
											<h1>Allowed Hosts</h1> (one IP address per line):
											<br><i>Use % to allow remote access from anywhere</i>
										</div>
										<div class="form-group">
											<div class="col-sm-6">
												<?php
												$RemoteHosts = $oMySQL->GetUserNameHosts($MySQLUserName);
												?>
												<textarea rows="15" name="HostList" id="form-field-11" class="form-control"><?php print implode("\n", $RemoteHosts); ?></textarea>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<input type="submit" value="Edit Hosts" data-style="zoom-in" class="btn btn-info ladda-button">
													<span class="ladda-spinner"></span>
													<span class="ladda-progress" style="width: 0px;"></span>
												</input>
											</div>
