...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>MySQL Management | <?php print $oSettings->GetWebCPTitle(); ?></title>
		<!-- start: META -->
		<meta charset="utf-8" />
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>MySQL <small>Add / remove, change passwords</small></h1>
							</div>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<table class="table table-bordered table-full-width table-hover table-striped" id="sample_1">
										<thead>
											<tr>
												<th>Database Name</th>
												<th>Username</th>
												<th class="hidden-xs">phpMyAdmin</th>
									...
									//print "Role: ".$oUser->Role."<p>";
										...
										$oMySQL->GetMySQLList($Array, $ArrayCount, $ClientID, $oUser->Role);
										...
										for($x = 0; $x < $ArrayCount; $x++)
										{
											...
											print "<td class=\"hidden-xs\"><a href=\"http://".$_SERVER["SERVER_NAME"].":10035\" target=\"_new\">phpMyAdmin</a></td>\r\n";

													print "<td class=\"center\">";
													print "<div class=\"visible-md visible-lg hidden-sm hidden-xs\">";
														
													print "<a href=\"EditPassword.php?id=".$Array[$x]["ID"]."\" class=\"btn btn-green tooltips\" data-placement=\"top\" data-original-title=\"Edit Password / Remote Hosts\"><i class=\"fa fa-edit fa fa-white\" style=\"color:white;\"></i></a>\n";
														
													print "<a href=\"DeleteMySQL.php?id=".$Array[$x]["ID"]."\" onclick=\"return ConfirmDelete(); return false;\" class=\"btn btn-bricky tooltips\" data-placement=\"top\" data-original-title=\"Delete MySQL\"><i class=\"fa fa-times fa fa-white\" style=\"color:white;\"></i></a>\n";
													print "</div>";
													print "<div class=\"visible-xs visible-sm hidden-md hidden-lg\">";
														print "<div class=\"btn-group\">";
															...
															print "<a role=\"menuitem\" tabindex=\"-1\" href=\"EditPassword.php?id=".$Array[$x]["ID"]."\">";
															print "<i class=\"fa fa-edit\"></i> Password / Hosts";
															print "</a>";
															print "</li>";
															
															print "<li role=\"presentation\">";
															print "<a role=\"menuitem\" tabindex=\"-1\" href=\"DeleteMySQL.php?id=".$Array[$x]["ID"]."\" onclick=\"return ConfirmDelete(); return false;\">";
															print "<i class=\"fa fa-times\"></i> Delete MySQL";
															print "</a>";
															print "</li>";																
															print "</ul>";
														print "</div>";
									...
									<a class="btn btn-primary" href="AddMySQL.php"><i class="fa fa-plus"></i>
									Add new MySQL</a>
