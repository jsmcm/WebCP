...
class StupidPass
{
	private $lang = array(
		...
		'environ' => 'Password cannot contain the email address or part of the email address',
	...
	public function __construct($maxlen = 40, $environ = array(), $dict = null, $lang = null, $options = array())
	{
		...
		$this->dict = (isset($dict)) ? $dict : $_SERVER["DOCUMENT_ROOT"].'/includes/classes/StupidPass.default.dict';
