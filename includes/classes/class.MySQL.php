...
class MySQL 
{
	...
	{
		require_once("/var/www/html/webcp/includes/classes/class.User.php");
                require_once("/var/www/html/webcp/includes/classes/class.Domain.php");
                require_once("/var/www/html/webcp/includes/classes/class.Package.php");
