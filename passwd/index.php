					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>Security <small> password protect directories</small></h1>
							</div>
									...
									//print "Role: ".$oUser->Role."<p>";
										...
										for($x = 0; $x < $ArrayCount; $x++)
										{
											...
											if($Array[$x]["type"] == 'primary')
											{
												...
												print "<td><a href=\"passwd.php?URL=".$Array[$x]["domain_name"]."&Path=".$Array[$x]["Path"]."\" target=\"_new\">".$Array[$x]["domain_name"]."</a></td>\r\n";
												print "</tr>";
											}
										}
										?>
