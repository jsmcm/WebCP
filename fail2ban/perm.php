					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>Permanent Blocks <small>Add / remove IP blocks</small></h1>
							</div>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<table class="table table-bordered table-full-width table-hover table-striped" id="sample_1">
										...
										$oFirewall->GetPermBanList($Array, $ArrayCount, $oUser->Role, $oUser->ClientID);


										for($x = 0; $x < $ArrayCount; $x++)
										{
											print "<tr>";
											print "<td>".$Array[$x]["IP"]."</td>\r\n";	
											...
											print "<td>".$Array[$x]["Country"]."</td>\r\n";
													...
													print "<a href=\"RemovePermBan.php?ID=".$Array[$x]["ID"]."&IP=".$Array[$x]["IP"]."\" class=\"btn btn-bricky tooltips\" data-placement=\"top\" data-original-title=\"Unblock\"><i class=\"fa fa-times fa fa-white\" style=\"color:white;\"></i></a>\n";
													print "</div>";
													print "<div class=\"visible-xs visible-sm hidden-md hidden-lg\">";
														print "<div class=\"btn-group\">";
															...
															print "<a role=\"menuitem\" tabindex=\"-1\" href=\"RemovePermBan.php?ID=".$Array[$x]["ID"]."&IP=".$Array[$x]["IP"]."\">";
										...
										?>
                                                                                ...
                                                                                <div class="col-sm-4" style="align:center;">
                                                                                        ...
                                                                                        <form name="ManualBan" action="ManualPermBan.php" method="post">
											<h3>Manually PERMANENTLY Ban an IP</h3>
