...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>Add SSL | <?php print $oSettings->GetWebCPTitle(); ?></title>
		<!-- start: META -->
		<meta charset="utf-8" />
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>Add SSL <small>select the domain to work with</small></h1>
							</div>
								...
								<div class="panel-body">
									...
									***************************************************************************/
									...
									<table class="table table-bordered table-full-width table-hover table-striped" id="sample_1">
										<thead>
											<tr>
												<th>Select domain to add SSL to</th>
											</tr>
										</thead>
										...
										for($x = 0; $x < $ArrayCount; $x++)
										{
											...
											if(true) //if( (($Array[$x]["type"] == 'primary') || ($Array[$x]["type"] == 'parked')) && (in_array($Array[$x]["domain_name"], $KeyArray) == false) )
											{
												$PrimaryDomainID = $Array[$x]["AncestorDomainID"];
												if($PrimaryDomainID == 0)
												{
													$PrimaryDomainID = $Array[$x]["id"];
												}
											 	print "<tr>";
												print "<td>";
												print "<a href=\"GenerateCRT.php?PrimaryDomainID=".$PrimaryDomainID."&Type=".$Array[$x]["type"]."&Path=".$Array[$x]["Path"]."&DomainUserName=".$Array[$x]["username"]."&DomainName=".$Array[$x]["domain_name"]."&DomainID=".$Array[$x]["id"]."\">".$Array[$x]["domain_name"]."</a>";
												print "</td>";
												print "</tr>";
											}
										}
