...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>Free SSL Management | <?php print $oSettings->GetWebCPTitle(); ?></title>
		<!-- start: META -->
		<meta charset="utf-8" />
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>Free SSL <small>Add / remove Free SSL</small></h1>
							</div>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<table class="table table-bordered table-full-width table-hover table-striped" id="sample_1">
										...
										<?php
										$SSLJson = `/usr/webcp/utils/get_freessl_list.sh`;
                								if($SSLJson != "")
							                        {
										...
										foreach($KeyArray as $Domain)
										{
											...
											print "<td><a href=\"#\" id=\"ssl_redirect_".$DomainID."\" data-type=\"select\" data-pk=\"".$DomainID."\" data-value=\"".$sslRedirect."\" data-original-title=\"SSL Redirect\"></a></td>\r\n";
													...
													print "<a href=\"DeleteSSL.php?PrimaryDomainID=".$PrimaryDomainID."&Type=".$InfoArray["DomainType"]."&DomainID=".$DomainID."&Domain=".$Domain."\" onclick=\"return ConfirmDelete('".$Domain."'); return false;\" class=\"btn btn-bricky tooltips\" data-placement=\"top\" data-original-title=\"Delete SSL for ".$Domain."\"><i class=\"fa fa-times fa fa-white\" style=\"color:white;\"></i></a>\n";
													print "</div>";
													print "<div class=\"visible-xs visible-sm hidden-md hidden-lg\">";
														print "<div class=\"btn-group\">";
															...
															print "<a role=\"menuitem\" tabindex=\"-1\" href=\"DeleteSSL.php?PrimaryDomainID=".$PrimaryDomainID."&Type=".$InfoArray["DomainType"]."&DomainID=".$DomainID."&Domain=".$Domain."\" onclick=\"return ConfirmDelete('".$Domain."'); return false;\">";
									...
									{
										print "Installing the SSL certificate software now. This usually can take up to about half an hour, please check back then";
										touch("../nm/letsencrypt.install");
									}
									?>
								</div>
							</div>
