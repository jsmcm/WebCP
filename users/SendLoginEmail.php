...
$somecontent = $somecontent."";
		...
		$somecontent = $somecontent."Web Mail: <a href=\"http://".$Domain."/mail\">http://".$Domain."/mail</a><br>";
...
$somecontent = $somecontent."</html>";
    ...
    $message = $somecontent;
		...
		$PlainTextMail."Good day ".$FirstName." ".$Surname.",";
		...
		$PlainTextMail = $PlainTextMail."Important Links\r\n-----------------------------------------\r\n\r\n";
		$PlainTextMail = $PlainTextMail."Web Control Panel: http://".$Domain."/webcp\r\n";
		$PlainTextMail = $PlainTextMail."Web Mail: http://".$Domain."/mail\r\n";
		$PlainTextMail = $PlainTextMail."phpMyAdmin: http://".$Domain."/mysql";
		
		$PlainTextMail = $PlainTextMail."\r\n\r\n";
		
		$PlainTextMail = $PlainTextMail."Temporary Links\r\n-----------------------------------------\r\n\r\n";
		$PlainTextMail = $PlainTextMail."NOTE:  The above links will only work once your domain name has been registered. Once registered, it can take up ";
		$PlainTextMail = $PlainTextMail."to 24 hours to be live. This is known as propogation.";
		$PlainTextMail = $PlainTextMail."\r\n\r\n";
		$PlainTextMail = $PlainTextMail."You should be able to access the same links as above using the following URLs:";
		
		$PlainTextMail = $PlainTextMail."\r\n";
		
		$PlainTextMail = $PlainTextMail."Web Control Panel: http://".$_SERVER["SERVER_NAME"]."/webcp\r\n";
		$PlainTextMail = $PlainTextMail."Web Mail: http://".$_SERVER["SERVER_NAME"]."/mail\r\n";
		$PlainTextMail = $PlainTextMail."phpMyAdmin: http://".$_SERVER["SERVER_NAME"]."/mysql";
		
		$PlainTextMail = $PlainTextMail."\r\n\r\n";
		
		$PlainTextMail = $PlainTextMail."Once your domain is live, you can use your own domain name to access these features.";
