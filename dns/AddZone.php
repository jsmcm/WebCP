...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>Add Zone | <?php print $oSettings->GetWebCPTitle(); ?></title>
		<!-- start: META -->
		<meta charset="utf-8" />
		...
		{
			ZoneName = document.AddZone.ZoneName.value;
			IPv4 = document.AddZone.IPv4.value;
			IPv6 = document.AddZone.IPv6.value;


			if( (IPv4 == "") && (IPv6 == "") )
			{
				alert("Need at least one IP");
				return false;
			}
			...
			if(ZoneName.indexOf("#") > -1)
			{
				...
				document.AddZone.ZoneName.focus();
				return false;
			...
			if (/^[a-zA-Z0-9][a-zA-Z0-9-]{1,61}[a-zA-Z0-9](?:\.[a-zA-Z]{2,})+$/.test(ZoneName))
			{
      				;
 			}
 			else
					...
					?>
						...
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								...
								<form name="AddZone" method="post" action="DoAddZone.php" class="form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												...
												<input name="ZoneName" type="text" placeholder="domain name" id="form-field-11" class="form-control">
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<span class="input-icon">
												<input name="IPv4" type="text" placeholder="100.000.000.100" id="form-field-11" class="form-control">
												<i class="fa clip-globe"></i>
												</span>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<span class="input-icon">
												<input name="IPv6" type="text" placeholder="2001:0db8:85a3:0000:0000:8a2e:0370:7334" id="form-field-11" class="form-control">
												<i class="fa clip-globe"></i>
												</span>
											</div>
										</div>
										...
										<div class="form-group">										
											<div class="col-sm-4">
												<input type="submit" value="Add Zone" data-style="zoom-in" class="btn btn-info ladda-button" onclick="return ValidateForm(); return false;">
