...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>Installer | <?php print $oSettings->GetWebCPTitle(); ?></title>
		<!-- start: META -->
		<meta charset="utf-8" />
	...
	<body>
		...
		<div class="main-container">
			...
			<div class="main-content">
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>Installer <small> Wordpress installer</small></h1>
							</div>
            	...
            	<h1>Select your installer</h1>

		<table class="table-hover table table-bordered table-full-width"">
		<tr style="border-bottom: solid 1px grey;">
			<td width="100"><a href="wordpress/index.php"><img src="wordpress.jpg" border="0"></a></td>
			<td><a href="wordpress/index.php">Wordpress installer</a></td>
		</tr>
		</table>
